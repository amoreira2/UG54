"""Build L12 · Capital Allocation I — content lives in l12_content.txt beside this file."""
import json, re, os
HERE=os.path.dirname(os.path.abspath(__file__))
block=open(os.path.join(HERE,"l12_content.txt"),encoding='utf8').read()
...
p=os.path.join(HERE,"L12_CapitalAllocationI_AI.ipynb")
