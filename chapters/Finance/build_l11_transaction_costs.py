"""Build L11 · Transaction Costs — content lives in l11_content.txt beside this file."""
import json, re, os
HERE=os.path.dirname(os.path.abspath(__file__))
block=open(os.path.join(HERE,"l11_content.txt"),encoding='utf8').read()
...
p=os.path.join(HERE,"L11_TransactionCosts_AI.ipynb")
